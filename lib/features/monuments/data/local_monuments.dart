...
const localMonuments = <Monument>[
  ...
  Monument(
    id: 'cenotafio-sorbo-tagliacozzo',
    idGlobal: 1004,
    name: 'Cenotafio',
    description:
        'Cenotafio situato in Piazza Miliaria, nella località Sorbo di Tagliacozzo.',
    deepDive: '',
    imageUrl: 'https://live.staticflickr.com/5047/5260406217_31312c4544_b.jpg',
    accessibility: [],
    latitude: 42.074222222,
    longitude: 13.315694444,
    locality: 'Sorbo di Tagliacozzo',
    address: 'Piazza Miliaria',
    municipality: 'Tagliacozzo',
    province: 'L’Aquila',
    region: 'Abruzzo',
    country: 'Italia',
  ),
  Monument(
    id: 'chiesa-santa-maria-delle-grazie-sorbo-tagliacozzo',
    idGlobal: 1005,
    name: 'Chiesa di Santa Maria delle Grazie',
    description:
        'Chiesa di Santa Maria delle Grazie situata in Piazza Miliaria, nella località Sorbo di Tagliacozzo.',
    deepDive: '',
    imageUrl: 'https://www.diocesidiavezzano.it/images/Parrocchie/sorbo.jpg',
    accessibility: [],
    latitude: 42.074250000,
    longitude: 13.315833333,
    locality: 'Sorbo di Tagliacozzo',
    address: 'Piazza Miliaria',
    municipality: 'Tagliacozzo',
    province: 'L’Aquila',
  ...
  Monument(
    id: 'colonna-miliaria-sorbo-tagliacozzo',
    idGlobal: 1006,
    name: 'Colonna miliaria',
    description:
        'Colonna miliaria situata in Piazza Miliaria, nella località Sorbo di Tagliacozzo.',
    deepDive: '',
    imageUrl:
        'https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhr_oqyrzqKEG6EvvWPF8Oamj4wDmo40MgkKGVHaT29qYVEOv7VKUnztU9VafYta5dsdGj5fmkfbiOExzQpHIXd3gwhhEkPd-1eBOTQdvBQAOyx63fVbPn-nkgZsRDIZAhjHfoYPSdKc0U/s320/Sorbo+-+Miliario.jpg',
    accessibility: [],
    latitude: 42.074333333,
    longitude: 13.315916667,
    locality: 'Sorbo di Tagliacozzo',
    address: 'Piazza Miliaria',
    municipality: 'Tagliacozzo',
    province: 'L’Aquila',
